...
// Equivalent of the original Apps Script submitCandidateSubmission() / processSubmission_().
//
// Bindings expected (set in the Cloudflare dashboard or wrangler.toml):
...
//
// Identity: when Cloudflare Access protects this site, every request to the
// origin (including this Function) carries a verified header:
//   Cf-Access-Authenticated-User-Email
// We treat that header as the authoritative identity, exactly like the old
// code used Session.getActiveUser().getEmail() and never trusted a
// browser-supplied email field.
